            ...
            try {
                withCredentials([[
                    ...
                    sh """
                        ...
                        echo "이미지 태깅 중..."
                        docker tag 528757801774.dkr.ecr.ap-northeast-2.amazonaws.com/castlehoo/frontend:${DOCKER_TAG} \
                                  528757801774.dkr.ecr.ap-northeast-2.amazonaws.com/castlehoo/frontend:latest
                        
                        echo "ECR로 이미지 푸시 중..."
                        docker push 528757801774.dkr.ecr.ap-northeast-2.amazonaws.com/castlehoo/frontend:${DOCKER_TAG}
                        
                        docker push 528757801774.dkr.ecr.ap-northeast-2.amazonaws.com/castlehoo/frontend:latest
